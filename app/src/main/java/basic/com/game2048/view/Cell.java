...
public class Cell extends View {
    ...
    public void moveToPosition(int tragetX, int tragetY, Direction direction) {
        ...
        if (direction == Direction.LEFT) {
            animator = ObjectAnimator.ofFloat(this, "TranslationX", 0, getX() - getLeft() - tragetX);
        } else if (direction == Direction.TOP) {
            animator = ObjectAnimator.ofFloat(this, "TranslationY", 0, getY() - getTop() - tragetY);
        } else if (direction == Direction.RIGHT) {
            animator = ObjectAnimator.ofFloat(this, "TranslationX", 0, tragetX - (getLeft() - getX()));
        } else {
            animator = ObjectAnimator.ofFloat(this, "TranslationY", 0, tragetY - (getTop() - getY()));
        }
    ...
    private Rect measureTextLocation(Rect textBound) {
        ...
        result.bottom = (viewHeight + textBound.width()) / 2;
        return result;
    }
